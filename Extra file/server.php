...
if (isset($_POST['reg_user'])) {
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO register (emp_id, email_id, emp_prof, password) 
  			  VALUES('$username', '$email', '$profession', '$password')";
...
if (isset($_POST['login_user'])) {
  ...
  if (count($errors) == 0) {
    $password = ($password);
    $query = "SELECT * FROM register WHERE emp_id='$username' AND password='$password'";
