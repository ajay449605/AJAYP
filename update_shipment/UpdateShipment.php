...
<body >   
    ...
    {
        $sid=$_POST['sid'];
    $sql = "SELECT sh_id from shipments where sh_id='$sid'";
        ...
        if(mysqli_num_rows($result)>0)
        {
            session_start();
            $_SESSION['sid']=$sid;
         header('location:UpdateShipmentStatus.php');
        }
        
        else
        {
          $message = "Shipment ID does not exist";
...
<form action="" method="post"><br><br><br>
    <h1 align="center">Enter Shipment ID</h1><br>
    &#8195; &emsp;&ensp;&#8195; &#8195; &emsp;&ensp;&#8195; &#8195; &emsp;&ensp;&#8195; &#8195; &emsp;&ensp;&#8195; &#8195; &emsp;&ensp;&#8195; 
    <input type="text" align="center" name="sid" style="margin-left:150px;" required > &nbsp;&nbsp;&nbsp;
    <button type="submit" name="submit">Get Shipment</button>
